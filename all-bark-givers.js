...
const url = 'https://sure-angeline-piotrswierzy-b061c303.koyeb.app/barking-power/leaderboard/totalBarksDonated/1000';
...
async function fetchAndProcessData() {
  try {
    ...
    const twitterHandles = data
      .filter(item => item.totalBarksDonated > 0)  // Filter for barksReceived > 0
